                                        ...
                                        <div class="col-12">
                                            ...
                                            ?>
                                             <p class="text-danger">
                                                ...
                                                if (!empty($this->session->flashdata('check_database'))) {
                                                 echo $this->session->flashdata('check_database'); 
                                                }
                                         ...
                                         <div class="col-12  mt-3">
                                            <p>Do you want to Sell/Rent Properties..?<a href="<?php echo base_url('seller_register'); ?>"> Sign Up</a></p>
                                        </div>
                                    </div>
                                    <?php  echo form_close(); ?>
                                </div>
