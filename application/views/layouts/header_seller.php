                ...
                <aside class="app-navbar">
                    ...
                    <div class="sidebar-nav scrollbar scroll_light">
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                <a class="has-arrow" href='<?php echo base_url(); ?>seller/' aria-expanded="false">
                              ...
                              <li>
                                ...
                                <ul aria-expanded="false">
                                    <li> <a href="<?php echo base_url('add_Properties'); ?>">add new</a> </li>
                                    <li> <a href="<?php echo base_url('list_Properties'); ?>">List</a> </li>
