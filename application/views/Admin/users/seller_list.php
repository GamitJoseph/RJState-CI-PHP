						...
						<div class="card-body py-4">
							<div class="d-flex align-items-center">
								...
								<div class="ml-3">
									...
									<p><span class="badge badge-warning-inverse px-2 py-1 mt-1">Seller</span></p>
								</div>
							</div>
							<div>
								<ul class="nav">
							...
							<a href="<?php echo base_url('/Seller_full/'. $d['user_id']); ?>" class="btn btn-round btn-inverse-info">View more</a>
							</div>
						</div>
					</div>
				</div>
