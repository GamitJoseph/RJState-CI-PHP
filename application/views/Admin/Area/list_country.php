							...
							<tbody>
								...
								foreach ($datalst as $d) :
									...
									<tr>
										...
										<td>
											<a href="<?php echo base_url(); ?>CountryEdit/<?php echo $d['country_id']; ?>" class="btn btn-icon btn-outline-primary btn-round mr-2 mb-2 mb-sm-0 "><i class="ti ti-pencil"></i></a>
											<a onclick="return confirm('sure want to delete ?')" href="<?php echo base_url(); ?>CountryDelete/<?php echo $d['country_id']; ?>" class="btn btn-icon btn-outline-danger btn-round mr-2 mb-2 mb-sm-0 "><i class="ti ti-trash"></i></a>
